<div class="caixa p-3 px-4 altura-minima">
    ...
    <div class="base-form alt p-2 pb-4  d-block border radius-4 mb-4 backoffice" style="background-color: #CEF6EC">
        <?php } else {?>
        <div class="base-form alt p-2 pb-4  d-block border radius-4 mb-4 backoffice">
            ...
            <form action="<?php echo URL_BASE . "produto/salvar"?>" method="post">
                <div class="rows  align-items-center">
                    ...
                    <div class="col-4 mb-3 ">
                        <span class="text-label">Estoque Máximo</span>
                        <input type="text" name="estoque_maximo" required id="estoque_maximo"
                            value="<?php echo $produto->estoque_maximo ?? null?>" class="form-campo">
                    </div>
                ...
                <table id="dataTable" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th align="center">Estoque Inicial</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"><?php echo $l->preco ?></td>
                            <td align="center"><?php echo $l->estoque_inicial ?></td>
                            ...
                            <td align="center">
                                ...
                                <a href="javascript:;" onclick="excluir(this)" data-entidade="produto"
                                    data-id="<?php echo $l->id_produto?>" class="ml-2" title="Excuir">
