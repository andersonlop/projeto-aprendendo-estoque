    <div class="caixa p-3 px-4 altura-minima">
        ...
        <div class="base-form alt p-2 pb-4  d-block border radius-4 mb-4 backoffice">
            <form action="<?php echo URL_BASE . "entrada/salvar"?>" method="post">
                <div class="rows  align-items-center">
                    ...
                    <div class="col-2 mb-3 ">
                        ...
                        <input type="text" name="qtde_entrada" required id="qtde_entrada" value="" class="form-campo">
                    </div>
            ...
            <div class="col-12 mb-3">
                <table id="dataTable" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        <?php $date = new DateTimeImmutable($l->data_entrada);?>
                        <tr>
                            <td align="center"><?php echo $l->id_entrada ?> </td>
                            <td align="center"><?php echo $date->format('d/m/Y'); ?> </td>
                            <td align="center"><?php echo $l->hora_entrada ?> </td>
                            <td align="center"><?php echo $l->nome ?> </td>
                            <td align="center"><?php echo $l->qtde_entrada ?> </td>
                            <td align="center"><?php echo $l->valor_entrada ?></td>
                            <td align="center"><?php echo $l->subtotal_entrada ?> </td>
                        </tr>
                        <?php }?>
